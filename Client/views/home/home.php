...
<head>
    ...
    <!-- <link rel="stylesheet" href="Client/public/assets/css/skins/skin-demo-4.css">-->
    <link rel="stylesheet" href="Client/public/assets/css/demos/demo-4.css">
</head>
...
<body>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="banner banner-overlay banner-overlay-light">
                    <a href="#">
                        <img src="Client/public/assets/images/demos/demo-4/banners/banner-1.png" alt="Banner">
                    </a>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="banner banner-overlay banner-overlay-light">
                    <a href="#">
                        <img src="Client/public/assets/images/demos/demo-4/banners/banner-2.jpg" alt="Banner">
                    </a>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="banner banner-overlay banner-overlay-light">
                    <a href="#">
                        <img src="Client/public/assets/images/demos/demo-4/banners/banner-3.png" alt="Banner">
                    </a>
    ...
    <div class="container">
        ...
        <div class="owl-carousel mt-5 mb-5 owl-simple" data-toggle="owl" data-owl-options='{
            ...
            <a href="#" class="brand">
                <img src="Client/public/assets/images/brands/logo-iphone.png" height="50" alt="Brand Name">
            </a>

            <a href="#" class="brand">
                <img src="Client/public/assets/images/brands/samsung.png" height="50" alt="Brand Name">
            </a>

            <a href="#" class="brand">
                <img src="Client/public/assets/images/brands/xiaomi.png" height="50" alt="Brand Name">
            </a>

            <a href="#" class="brand">
                <img src="Client/public/assets/images/brands/vivo.png" height="50" alt="Brand Name">
            </a>

            <a href="#" class="brand">
                <img src="Client/public/assets/images/brands/nokia.png" height="50" alt="Brand Name">
            </a>

            <a href="#" class="brand">
                <img src="Client/public/assets/images/brands/assus.png" alt="Brand Name">
            </a>
    ...
    <div class="container">
        <div class="cta cta-border mb-5" style="background-image: url(Client/public/assets/images/demos/demo-4/bg-1.jpg);">
            <img src="Client/public/assets/images/demos/demo-4/camera.png" alt="camera" class="cta-img">
            <div class="row justify-content-center">
                <div class="col-md-12">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 deal-col">
                <div class="deal" style="background-image: url('Client/public/assets/images/demos/demo-4/deal/bg-1.jpg');">
                    <div class="deal-top">
            ...
            <div class="col-lg-6 deal-col">
                <div class="deal" style="background-image: url('Client/public/assets/images/demos/demo-4/deal/bg-2.jpg');">
                    <div class="deal-top">
