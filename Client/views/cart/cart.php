                                            ...
                                            <td class="quantity-col">
                                                <div class="cart-product-quantity" style="display: flex;">
                                                    <?php if ($value['SoLuongTrongGio'] == 1) { ?>
                                                        <button type="button" class="btn-unstyled" data-toggle="modal" onclick="setDeleteId(<?= $value['MaGH'] ?>)" data-target="#exampleModalCenter">
                                                            -
                                                        </button>
                                                    <?php } else { ?>
                                                        <a href="./?act=cart&xuli=delete&id=<?= $value['MaGH'] ?>">
                                                            -
                                                        </a>
                                                    <?php } ?>
                                                    &nbsp; &nbsp;<p><?= $value['SoLuongTrongGio'] ?></p> &nbsp; &nbsp;
                                                    <a href="./?act=cart&xuli=update&id=<?= $value['MaGH'] ?>">+</a>
