    ...
    <div class="header-middle">
        <div class="container">
            <div class="header-left">
                ...
                <a href="." class="logo">
                    <img src="Client/public/assets/images/logo.png" alt="YShop Logo" width="220" height="120">
                </a>
            </div><!-- End .header-left -->
                        ...
                        <ul class="compare-products">
                            <li class="compare-product">
                                ...
                                <?php if (isset($_SESSION['isLogin'])) {
                                    ...
                                    <h4 class="compare-product-title"><a href="account">Đăng nhập</a></h4>
                                <?php } ?>
                            </li>
                            <li class="compare-product">
                                <a href="./personal" class="btn-remove" title="Remove Product"><i class="fa-solid fa-arrow-right"></i></a>
                                <h4 class="compare-product-title"><a href="personal">Tài khoản của tôi</a></h4>
                            </li>
                        </ul>
                        <?php if (isset($_SESSION['isLogin'])) { ?>
                ...
                <div class="dropdown cart-dropdown">
                    <a href="#" class="dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
                        <div class="icon">
                            ...
                            <?php if (isset($_SESSION['id_ND']) && count($data_cart)) { ?>
                        ...
                        <p style="font-size: 1.8rem; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; margin-top: 15px; color: white; font-weight: 500; display:inline">
                            Giỏ Hàng</p>
                    </a>
                    <?php if (isset($_SESSION['id_ND']) && count($data_cart)) { ?>
                    ...
                    <div class="dropdown-menu">
                        <nav class="side-nav">
                            <ul class="menu-vertical sf-arrows">
                                <li class="item-lead"><a href="#">Ưu đãi hàng ngày</a></li>
