            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="widget widget-about">
                        <img src="./Client/public/assets/images/logo.png" class="footer-logo" alt="Footer Logo" width="205" height="25">
    ...
    <div class="footer-bottom">
        <div class="container">
            ...
            <figure class="footer-payments">
                <img src="Client/public/assets/images/Payment-Icons.png" alt="Payment methods" width="272" height="20">
