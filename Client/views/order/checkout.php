<main class="main">
    <div class="page-header text-center"
        style="background-image: url('Client/public/assets/images/page-header-bg.jpg')">
        <div class="container">
            <h1 class="page-title">Thủ tục thanh toán<span>Shop</span></h1>
        </div><!-- End .container -->
    </div><!-- End .page-header -->
                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            ...
                            <input type="text" name="NguoiNhan" class="form-control"
                                value="<?= $data_user['Ho'] ?> <?= $data_user['Ten'] ?>" required>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="DiaChi" class="form-control"
                                        value="<?= $data_user['DiaChi'] ?>" required>
                                </div><!-- End .col-sm-6 -->

                                <div class="col-sm-6">
                                    <label>Quận / Huyện<span class='text-danger'>*</span></label>
                                    <input type="text" name="Quan" class="form-control"
                                        value="<?= $data_user['Quan'] ?>" required>
                                </div><!-- End .col-sm-6 -->
                            </div><!-- End .row -->
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="Phuong" class="form-control"
                                        value="<?= $data_user['Phuong'] ?>" required>
                                </div>
                                <div class="col-sm-6">
                                    <label>Số điện thoại<span class='text-danger'>*</span></label>
                                    <input type="tel" name="SDT" class="form-control" value="<?= $data_user['SDT'] ?>"
                                        required>
                                </div><!-- End .col-sm-6 -->
                            </div><!-- End .row -->
                            ...
                            <textarea name="Note" class="form-control" style="resize: none" cols="30" rows="4"
                                ...
                                <div class="accordion-summary" id="accordion-payment">
                                    <div class="card">
                                        <div class="card-header" id="heading-3">
                                            <h2 class="card-title">
                                                <input class="collapsed" type="radio" name="PhuongThucTT"
                                                    value="Cash on delivery" role="button" data-toggle="collapse"
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="heading-4">
                                            <h2 class="card-title">
                                                <input type="radio" name="PhuongThucTT" value="PayPal" class="collapsed"
                                                    role="button" data-toggle="collapse" href="#collapse-4"
                                                    aria-expanded="false" aria-controls="collapse-4">
                                                PayPal<img height="10px"
                                                    src="./Client/public/assets/images/paypal_logo_icon_170865.png"
                                                    alt="Paypal" />
