            ...
            <div class="container">
                <div class="checkout-discount">
                    <form action="#">
                        ...
                        <label for="checkout-discount-input" class="text-truncate">Có mã giảm giá? <span>Nhấn vào đây để nhập mã của bạn</span></label>
                    </form>
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="Phuong" class="form-control" value="<?= $data_user['Phuong'] ?>" required>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label" for="checkout-diff-address">Gửi đến một địa chỉ khác?</label>
                                ...
                                <div class="accordion-summary" id="accordion-payment">
                                    <div class="card">
                                        ...
                                        <div id="collapse-3" class="collapse" aria-labelledby="heading-3" data-parent="#accordion-payment">
                                            <div class="card-body">COD được hiểu là nhận hàng rồi mới thành toán tiền mặt. Điều này có thể có nghĩa là thanh toán được thực hiện tại điểm giao hàng
                                            </div><!-- End .card-body -->
                                        </div><!-- End .collapse -->
                                    </div><!-- End .card -->
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapse-4" class="collapse" aria-labelledby="heading-4" data-parent="#accordion-payment">
                                            <div class="card-body">
                                                Đây là dịch vụ thanh toán và chuyển khoản điện tử thay thế cho các phương thức truyền thống sử dụng giấy tờ như séc và các lệnh chuyển tiền.
                                            </div><!-- End .card-body -->
                                        </div><!-- End .collapse -->
                                    </div><!-- End .card -->
                                </div><!-- End .accordion -->
