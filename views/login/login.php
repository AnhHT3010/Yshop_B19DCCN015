<main class="main">
    ...
    <div
        style="background-image: url('https://png.pngtree.com/thumb_back/fh260/back_our/20190621/ourmid/pngtree-black-atmosphere-home-life-password-lock-smart-lock-full-screen-poster-image_188879.jpg') ; background-size: cover;">
                            ...
                            <div class="tab-pane fade" id="signin-2" role="tabpanel" aria-labelledby="signin-tab-2">
                                <form action="login" id="form1" method="post" role="form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="singin-email-2" name="taikhoan"
                                            required>
                                    </div><!-- End .form-group -->
                                    ...
                                    <div class="form-footer">
                                        <button for="form1" name="submit" type="submit"
                            ...
                            <div class="tab-pane fade show active" id="register-2" role="tabpanel"
                                ...
                                <form action="./?act=taikhoan&xuli=dangky" method="post" role="form" id="form2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="TaiKhoan" class="form-control" id="register-password"
                                            required>
                                    </div><!-- End .form-group -->
                                    <div class="form-group">
                                        <label for="register-password">Email address *</label>
                                        <input type="email" name="Email" class="form-control" id="register-password"
                                            required>
                                    </div><!-- End .form-group -->
                                    <div class="form-group">
