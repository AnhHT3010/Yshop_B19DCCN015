            ...
            <div class="tile">
                ...
                <div class="tile-body">
                    <div class="row element-button">
                        <div class="col-sm-2">
                            <a href="?mod=loaisanpham&act=add" class="btn btn-add btn-sm"><i class="bx bxs-comment-add"></i> Thêm loại sản phẩm</a>
                        </div>
                        <div class="col-sm-2">
                    ...
                    <form class="row" action="./?mod=danhmuc&act=store" method="POST" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div id="boxchoice">
                                <a href="javascript:" class="Choicefile"><i class="bx bxs-image-add"></i> Chọn
                                    ảnh</a>
...
<script>
    const choiceFile = document.getElementById("boxchoice");
