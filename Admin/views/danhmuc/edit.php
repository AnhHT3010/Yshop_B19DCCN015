            ...
            <div class="tile">
                ...
                <div class="tile-body">
                    <div class="row element-button">
                        <div class="col-sm-2">
                            <a href="?mod=loaisanpham&act=add" class="btn btn-add btn-sm"><i class="bx bxs-comment-add"></i> Thêm danh mục mới</a>
                        </div>
                        <div class="col-sm-2">
                    ...
                    <form class="row" action="./?mod=danhmuc&act=update" method="POST" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6">
                            <label class="control-label">Ảnh danh mục gốc</label>
                            <div id="thumbold">
                                <img height="400" width="auto" alt="Thumb image" src="<?= $data['HinhAnh'] ?>" />
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div id="thumbbox">
                                <img height="400" width="auto" alt="Thumb image" id="thumbimage" style="display: none" />
                                <a class="removeimg" href="javascript:"></a>
                            </div>
                            <div id="boxchoice">
