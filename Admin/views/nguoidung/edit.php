            ...
            <div class="tile">
                ...
                <div class="tile-body">
                    ...
                    <div class="row element-button">
                        <div class="col-sm-2">
                            <a href="?mod=nguoidung&act=add" class="btn btn-add btn-sm"><i
                                    class="bx bxs-comment-add"></i>Thêm Tài Khoản</a>
                        </div>
                    </div>

                    <form class="row" action="./?mod=nguoidung&act=update" method="POST" role="form"
                        enctype="multipart/form-data_user_detail">
                        <input class="form-control" name="MaND" type="hidden" value="<?= $data_user_detail['MaND'] ?>">
                        <div class="form-group col-md-4">
                            <label class="control-label">Tên tài khoản</label>
                            <input class="form-control" name="TaiKhoan" value="<?= $data_user_detail['TaiKhoan'] ?>"
                                type="text" required>
                        </div>
                        <div class="form-group col-md-4">
                            <label class="control-label">Họ</label>
                            <input class="form-control" name="Ho" type="text" value="<?= $data_user_detail['Ho'] ?>"
                                required>
                        </div>
                        <div class="form-group col-md-4">
                            <label class="control-label">Tên</label>
                            <input class="form-control" name="Ten" value="<?= $data_user_detail['Ten'] ?>" type="text"
                                required>
                        </div>
                        <div class="form-group col-md-4">
                            <label class="control-label">Địa chỉ email</label>
                            <input class="form-control" name="Email" value="<?= $data_user_detail['Email'] ?>"
                                type="email" required>
                        </div>
                        <div class="form-group col-md-4">
                            <label class="control-label">Tỉnh/Thành Phố</label>
                            <input class="form-control" type="text" name="DiaChi"
                                value="<?= $data_user_detail['DiaChi'] ?>" required>
                        </div>
                        <div class="form-group col-md-4">
                            <label class="control-label">Quận/Huyện</label>
                            <input class="form-control" type="text" name="Quan" value="<?= $data_user_detail['Quan'] ?>"
                                required>
                        </div>
                        <div class="form-group col-md-4">
                            <label class="control-label">Địa chỉ thường trú</label>
                            <input class="form-control" type="text" name="Phuong"
                                value="<?= $data_user_detail['Phuong'] ?>" required>
                        </div>
                        <div class="form-group  col-md-4">
                            <label class="control-label">Số điện thoại</label>
                            <input class="form-control" name="SDT" value="<?= $data_user_detail['SDT'] ?>" type="tel"
                                required>
                        </div>
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-10">
                            ...
                            <div id="myfileupload">
                                <input type="hidden" id="uploadfile" name="HinhAnh"
                                    value="<?= $data_user_detail['HinhAnh'] ?>" />
                            </div>
                            <div id="thumbbox">
                                <img height="auto" class="img-cover" id="thumbimage" width="200px" alt="Thumb image"
                                    src="<?= $data_user_detail['HinhAnh'] ?>" />
                                <a class="corner-mark" id="new-image" onclick="removeImage(this)">
                                    <div>&times;</div>
                                </a>
                            </div>
                            <div id="boxchoice">
                                <a href="javascript:" class="Choicefile" id="Choicefile"><i
                                        class="bx bxs-image-add"></i> Chọn
                                    ảnh</a>
